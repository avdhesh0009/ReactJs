...
function Login(){
    ...
    const login=async(data)=>{
        ...
        try{
           ...
           if(session){
            ...
            navigate("/")
           // Link se usse click krna padega khi aur redirect krne ke liye
           // per navigate se forcefully khi aur navigate krwa skte hain
           }
        }
        catch(error){
    ...
    return(
        <div className="flex items-center justify-center w-full">
            ...
            {/* handle submit ek event hai */}
            <form onSubmit={hanleSubmit(login)}
            className="mt-8">
                <div className="space-y-5">
                    ...
                    type="email"
                    // yeh react hook form se dekhna hai 
                    {...register("email",{
                        required:true,
                        validate:{
